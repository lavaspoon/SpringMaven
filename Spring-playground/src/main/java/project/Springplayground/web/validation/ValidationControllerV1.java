...
public class ValidationControllerV1 {
    ...
    public ValidationControllerV1(UserProfileMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public String searchUser(Model model){
        ...
        return "/validation/v1/searchUser";
    }
    //회원 상세 조회
    @GetMapping("/items/{id}")
    public String item(@PathVariable String id, Model model) {
        ...
        return "/validation/v1/userInform";
    }
